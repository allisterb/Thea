...
{
 "use strict";
 var Global,Thea,Web,Client,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Handler,Thea$Web_Templates,Var,ConcreteVar,Snap,Collections,List,Unchecked,System,Guid,SC$1,Dictionary,HashSet,Client$1,Seq,Client$2,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Object,View,AttrProxy,CheckedInput,Numeric,DictionaryUtil,Enumerator,T,EventTarget,Node,JS,DomUtility,SC$2,WindowOrWorkerGlobalScope,SC$3,Docs,SC$4,DocElemNode,CharacterData,Storage,Elt,Prepare,Slice,KeyCollection,An,Settings,Mailbox,HashSetUtil,Attrs,Dyn,Array,ArrayStorage,Attrs$1,AttrModule,List$1,T$1,Strings,Updates,Docs$1,RunState,NodeSet,Anims,SC$5,String,SC$6,Concurrency,AppendList,Char,DynamicAttrNode,SC$7,Easing,AsyncBody,SC$8,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Queue,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,console,Math,$,Date;
 Global=self;
 Thea=Global.Thea=Global.Thea||{};
 Web=Thea.Web=Thea.Web||{};
 ...
 Thea$Web_Templates=Global.Thea$Web_Templates=Global.Thea$Web_Templates||{};
 Var=UI.Var=UI.Var||{};
 ...
 SC$1=Global.StartupCode$Thea_Web$Client=Global.StartupCode$Thea_Web$Client||{};
 ...
 {
  var newName,a,b,t,L,p,i;
  newName=Var$1.Create$1("");
  a=(b=(t=(L=Doc.Convert(function(name)
  {
   var b$1,p$1,i$1;
   return(b$1=ProviderBuilder.Make().WithHole({
    ...
    $0:"name",
    $1:name
   }),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],Thea$Web_Templates.listitem(p$1[0])),(b$1.i=i$1,i$1)))).get_Doc();
  },Client.People().v),ProviderBuilder.Make().WithHole({
   $:0,
   $0:"listcontainer",
   $1:L
  })).WithHole({
  ...
  },function()
  {
   ...
   newName.Set("");
  }))),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],Thea$Web_Templates.main(p[0])),(b.i=i,i)))).get_Doc();
 ...
 Thea$Web_Templates.listitem=function(h)
 {
 ...
 Thea$Web_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
